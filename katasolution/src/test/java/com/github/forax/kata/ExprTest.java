...
import com.github.forax.kata.Expr.Add;
import com.github.forax.kata.Expr.Mul;
import com.github.forax.kata.Expr.Value;
import com.github.forax.kata.Expr.Var;
...
public class ExprTest {
  ...
  public void parseAll() {
    ...
    var exprs = exprTexts.lines()
        .map(line -> List.of(line.split(" ")))
        .map(Expr::parse)
        .toList();

    assertEquals(List.of(7, 5, 9),
        exprs.stream().map(expr -> expr.eval(Map.of("a", 3, "b", 2))).toList());
  }
}